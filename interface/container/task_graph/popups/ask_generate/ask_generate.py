...
class AskGenerate(Popup):
    ...
    def generate(self):
        ...
        try:
            ...
            e_max_weight = int(self.edges_max_weight.text) if self.edges_max_weight.text else None
            if e_max_weight is not None and e_max_weight < e_min_weight:
            ...
            self.parent_tab.generate(n_min_weight, n_max_weight, nodes, correlation, e_min_weight, e_max_weight)
